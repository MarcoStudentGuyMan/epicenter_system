        ...
        <div className="app-container">
            ...
            <section className="profileA-align"> 
                ...
                <main className="main-content">
                    ...
                    <div className='profileA-content'>
                    <ul>
                        <li>First Name:<input placeholder="Enter First Name" /></li>
                        <li>Last Name:<input placeholder="Enter Last Name" /></li>
                        <li>Email:<input placeholder="Enter Email" /></li>
                        <li>Password:<input placeholder="Enter Password" /></li>
                        <li>Contact Number:<input placeholder="Enter Contact Number" /></li>
                    </ul>
